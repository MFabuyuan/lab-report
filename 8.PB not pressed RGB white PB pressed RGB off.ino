/*
  ...
  When pushButton is not pressed it RGB Led is HIGH (1) and RGB Led is LOW (0) when pushButton is pressed.
...
void loop() {
  ...
  if (buttonState==HIGH) {        //pushButton is not pressed RGB led  is on (HIGH)
